...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "club_type")
@JsonSubTypes({
	@JsonSubTypes.Type(value = AcademicStudentClub.class, name = "academic"),
	@JsonSubTypes.Type(value = NonAcademicStudentClub.class, name = "non_academic")
})
